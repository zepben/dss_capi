...
typedef struct _SummaryReport SummaryReport;
typedef struct _EventLogEntry EventLogEntry;
typedef struct _EventLog EventLog;
typedef struct _TapsReport TapsReport;
typedef struct _LoopReport LoopReport;
typedef struct _IsolatedArea IsolatedArea;
typedef struct _IsolatedElement IsolatedElement;
typedef struct _IsolatedBusesReport IsolatedBusesReport;
typedef struct _LossesEntry LossesEntry;
typedef struct _LossesTotals LossesTotals;
typedef struct _NodeMismatch NodeMismatch;
typedef struct _KVBaseMismatch KVBaseMismatch;
